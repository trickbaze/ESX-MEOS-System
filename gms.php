...
<head>
  ...
  <title>Zoutelande - <?php if (isset($_GET['id'])) { echo "Aangifte (".$_GET['id'].")"; } else { echo "Aangifte invoeren"; }?></title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="/gms">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text"><u>Portofoon</u></span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
	  ...
	  <iframe scrolling="no" frameborder="0" style="position: relative; height: 900px; width: 100%;" src="https://gms.zoutelanderp.nl/gms/?meos_secret=<?php echo $meos_secret; ?>"></iframe>
    <!-- /.container-fluid-->
    <!-- /.content-wrapper-->
