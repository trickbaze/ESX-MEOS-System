...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">Voer je MEOS Gegevens in<div class="pull-right"><a href="#" data-toggle="modal" data-target="#exampleModal">Disclaimer</a></div></div>
      <div class="card-body">
	  <img height="130" src="img/test1.png"><br><br>
        <form method="POST">
		<input type="hidden" name="form" value="<?php if (isset($_GET['2fa'])) { echo '2fa'; } else { echo 'login'; } ?>">
		  ...
		  <dv/>
		  <hr>
		  <b align="center">Waarschuwing: Als je gebruik maakt van het MEOS als politieagent, moet je je er van bewust zijn dat je dit doet conform artikel 8 van de Wet politiegegevens.</b>
		  <hr>
          <div class="form-group">
          </div>
